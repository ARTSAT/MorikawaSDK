...
#ifndef __TST_CRITICALSECTION_H
#define __TST_CRITICALSECTION_H

#include "TSTType.h"

namespace tst {

class TSTCriticalSection {
    private:
                bool                _state;
                unsigned char       _sreg;
...
/*public */inline TSTCriticalSection::~TSTCriticalSection(void)
{
    unlock();
}
